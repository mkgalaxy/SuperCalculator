...
@Suppress("EqualsBetweenInconvertibleTypes", "DEPRECATION", "MemberVisibilityCanBePrivate",
    "ReplaceJavaStaticMethodWithKotlinAnalog", "UsePropertyAccessSyntax",
...
class CalculatorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val changeCurrency: Button = findViewById(R.id.changeCurrency)
        val changeDater: Button = findViewById(R.id.changeDate)
        val bmiChanger: Button = findViewById(R.id.bmi)
        changeCurrency.setOnClickListener {
            val intent = Intent(this,ChangeCurrencyActivity::class.java)
            startActivity(intent)// goes to change currencies to tooman
        }
        changeDater.setOnClickListener {
            val intent = Intent(this,ChangeDateActivity::class.java)
            startActivity(intent)// goes to change date in minute
        }
        bmiChanger.setOnClickListener {
            val intent = Intent(this,bmiActivity::class.java)
            startActivity(intent)// goes to bmi activity
        }
        ...
        bsqrt.setOnClickListener {
            if (tvMain.text.toString().isEmpty()) {
                Toast.makeText(this, "خطای مقدار نامشخص!!!", Toast.LENGTH_SHORT).show()
            } else {
                val str: String = tvMain.text.toString()
        ...
        bsquare.setOnClickListener {
            if (tvMain.text.toString().isEmpty()) {
                Toast.makeText(this, "خظای مقدار نامشخص!!!", Toast.LENGTH_SHORT).show()
            } else {
